...
{
    public partial class AddEditOperatorScreenAccessMaster : FormBase
    {
        private static string _screenName = "AddEditScreenAccessMaster - frmAddEditScreenAccessMaster";
        private static string _className = "frmAddEditScreenAccessMaster";
        ...
        /// 
        /// </summary>
        public AddEditOperatorScreenAccessMaster()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateForm())
            {
                ...
                {
                    SecurityModuleBLL.UpdateOperatorModulePermissionMapping(_moduleScreenMappingId, moduleId, screenId, permissionOper, permissionId, workStationConfig);
                    GlobalMessageBox.Show(Messages.DATA_SAVED_SUCCESSFULLY, Constants.AlertType.Information, Messages.INFORMATION, GlobalMessageBoxButtons.OK);
                }
                else if (string.Compare(_addEdit, "ADD", true) == 0)
                {
                    if (SecurityModuleBLL.IsOperatorModulePermissionMappingExist(moduleId, screenId))
                    {
                    ...
                    {
                        SecurityModuleBLL.InsertOperatorModulePermissionMapping(moduleId, screenId, permissionOper, permissionId, workStationConfig);
                        GlobalMessageBox.Show(Messages.DATA_SAVED_SUCCESSFULLY, Constants.AlertType.Information, Messages.INFORMATION, GlobalMessageBoxButtons.OK);
                    }
                }
                BacktoParentPage();
        ...
        /// <summary>
        /// cmbModule_SelectedIndexChanged
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
       ...
       /// <summary>
        /// AddEditScreenAccessMaster_Load
       /// </summary>
       /// <param name="sender"></param>
       /// <param name="e"></param>
        private void AddEditScreenAccessMaster_Load(object sender, EventArgs e)
        {
            BindModuleList();
            cmbModule.SelectedIndexChanged += cmbModule_SelectedIndexChanged;
            BindPermissionList();
            ...
            if (string.Compare(_addEdit, "EDIT", true) == 0)
            {
                _moduleScreenMappingId = Convert.ToInt32(_objSelectedGridRow.Cells["OperatorModulePermissionMappingId"].Value.ToString());
        ...
        /// <summary>
        /// AddEditScreenAccessMaster_Leave
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void AddEditScreenAccessMaster_Leave(object sender, EventArgs e)
        {
            this.MdiParent.Text = Messages.OPERATOR_SCREEN_ACCESS_MASTER;
        }
    }
}
