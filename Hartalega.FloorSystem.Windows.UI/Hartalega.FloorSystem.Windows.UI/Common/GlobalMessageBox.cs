...
namespace Hartalega.FloorSystem.Windows.UI.Common
{
    ...
    public partial class GlobalMessageBox : Form
    {
        private GlobalMessageBox()
        {
            ...
            this.Font = new Font("Microsoft Sans Serif", 18F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(0)));
        ...
        public static string Show(Label Label, string Title = "", List<Button> Buttons = null, PictureBox Image = null, Icon icon=null)
        {
        ...
        public static string Show(string Label, string Title = "", List<Button> Buttons = null, Icon icon = null,PictureBox Image = null)
        {
            ...
            return Show(Labels, Title, Buttons, Image,icon);
        }
        public static string Show(List<Label> Labels = null, string Title = "", List<Button> Buttons = null, PictureBox Image = null, Icon icon = null)
        {
            ...
            foreach (Label l in Labels)
            {
                ...
                l.Font = new Font("Microsoft Sans Serif", 18F, FontStyle.Bold, GraphicsUnit.Point, ((byte)(0)));
                il.Add(l.Width);
            }
