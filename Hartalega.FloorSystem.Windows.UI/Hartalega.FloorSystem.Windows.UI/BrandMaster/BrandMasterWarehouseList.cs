...
{
    public partial class BrandMasterWarehouseList : FormBase 
    {
        ...
        public BrandMasterWarehouseList(string loggedInUser)
        {
        ...
        private void BrandMasterWarehouseList_Load(object sender, EventArgs e)
        {
            getList();
        }
        ...
        private void dgvLineSelection_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex > Constants.MINUSONE)
            {
                if (dgvLineSelection.Rows.Count > 0 && dgvLineSelection.Rows[e.RowIndex] != null)
                {
                    ...
                    new BrandMasterWarehouseEdit(_brandMasterDTO, _loggedInUser).ShowDialog();
                    getList();
                }
            }
        }
        ...
        private void getList()
        {
            ...
            if (brandMasterDTOList != null)
            {
                for (int i = 0; i < brandMasterDTOList.Count; i++)
                {
                    ...
                    dgvLineSelection[5, i].Value = brandMasterDTOList[i].PALLETCAPACITY;
                }
            }
        }
