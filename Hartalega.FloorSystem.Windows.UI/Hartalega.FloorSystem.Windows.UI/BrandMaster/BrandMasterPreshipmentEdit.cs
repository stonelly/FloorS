...
{
    public partial class BrandMasterPreshipmentEdit : FormBase
    {
        ...
        public BrandMasterPreshipmentEdit(BrandMasterDTO brandMasterDTO, string loggedInUser)
        {
            try
            {
                InitializeComponent();
            ...
            {
                ExceptionLogging(ex, _screenName, _className, "BrandMasterPreshipmentEdit", null);
                return;
            }
        }
        ...
        private void BrandMasterPreshipmentEdit_Load(object sender, EventArgs e)
        {
            try
            {
                getBrandLineDetails();
            ...
            {
                ExceptionLogging(ex, _screenName, _className, "BrandMasterPreshipmentEdit_Load", null);
                return;
            }
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(txtPreshipment.Text))
                    if (!int.TryParse(txtPreshipment.Text, out integer))
                        vldmsg = "Preshipment Plan";
                ...
                if (string.IsNullOrEmpty(vldmsg))
                {
                    ...
                    newitem.PALLETCAPACITY = olditem.PALLETCAPACITY;
