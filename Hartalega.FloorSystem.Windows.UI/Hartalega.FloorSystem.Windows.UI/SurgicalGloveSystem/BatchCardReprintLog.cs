...
namespace Hartalega.FloorSystem.Windows.UI.SurgicalGloveSystem
{
    public partial class BatchCardReprintLog : FormBase
    {
        ...
        private static string _screenName = "Surgical Batch Card Reprint Log";
        private static string _className = "SurgicalBatchCardReprintLog";
        private static string _screenNameForAuthorization = "Print Surgical Batch Card Log";       
        #endregion
        ...
        public BatchCardReprintLog()
        {
            ...
            //menuStrip2.Items[2].Enabled = false;
            BindPlantList();
        ...
        private void BindPlantList()
        {
            try
            {
                cmbPlant.BindComboBox(SurgicalGloveBLL.GetPlantList(), true);
            }
            catch (FloorSystemException ex)
            {
        ...
        private void getBatchCardReprintLog()
        {
            ...
            try
            {
                ...
                lstRePrintBatchCardDTO = SurgicalGloveBLL.GetBatchCardReprintLog(dpfromdate.Value, dptodate.Value, Convert.ToString(cmbPlant.SelectedValue));
        ...
        private void menuStrip2_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            switch (itemText)
            {
                ...
                case Constants.MANUAL_PRINT_BATCH_CARD:
                    Login _passwordForm = new Login(Constants.Modules.SURGICALGLOVESYSTEM, _screenNameForAuthorization);
