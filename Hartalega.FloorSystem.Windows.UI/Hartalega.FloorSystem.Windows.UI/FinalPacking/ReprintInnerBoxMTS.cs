...
{
    public partial class ReprintInnerBoxMTS : FormBase
    {
        # region PRIVATE variables
        private string _screenname = "Re-print Inner Box";
        private string _uiClassName = "ReprintInnerBoxMTS";
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ReprintInnerBoxMTS_Load(object sender, EventArgs e)
        {
            this.Hide();
