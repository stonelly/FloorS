...
{
    public partial class ScanBatchCardInnerOuterMTS : FormBase
    {
        ...
        #region CONSTRUCTOR
        public ScanBatchCardInnerOuterMTS()
        {
            InitializeComponent();
        }
        # endregion
        ...
        /// </summary>
        /// <param name="e"></param>
        private void ScanBatchCardInnerOuterMTS_Load(object sender, EventArgs e)
        {
            try
            {
            ...
            {
                ExceptionLogging(ex, _screenname, _uiClassName, "ScanBatchCardInnerOuterMTS_Load", null);
            }
        }
        ...
        private void Print_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (ValidateBoxesPacked())  // Validate Boxes entered on Print
                        if (SerilaNumberValidation(Convert.ToDecimal(txtSerialNumber.Text), true)) // Validate SerialNumber scanned on print
                        {
                            if (PopulateAssociatedPalletID(true))
                            {
                                ...
                                objFinalPackingDTO.FGBatchOrderNo = _poNumber;
                                ...
                                if (rowsaffected > Constants.ZERO)
                                {
                                    try
                                    {
                                        ...
                                        while (palletCasesCount > Constants.ZERO)
                                        {
                                            if (palletCasesCount > _palletcapacity - selectedPalletCasesPlaced)
                                            {
                                                ...
                                                //InsertDataToEWNTable(_palletid, false, objFinalPackingDTO); //20220110: HSB SIT2 Issue# 36: MTS pallet MTS pallet not require insert record into EWN_CompletedPallet table.
                                                //end edit (17Aug2017)
                                        ...
                                        while (preshipmentPalletCasesCount > Constants.ZERO)
                                        {
                                            if (preshipmentPalletCasesCount > _palletcapacity - selectedPreshipPalletCasesPlaced)
                                            {
                                                ...
                                                //InsertDataToEWNTable(_preshipmentPltID, true, objFinalPackingDTO);  //20220110: HSB SIT2 Issue# 36: MTS pallet MTS pallet not require insert record into EWN_CompletedPallet table.
                                                //end edit (17Aug2017)                                               
                                                PalletSelection _PalletSelectionForm = new PalletSelection();
                                    ...
                                    if (isFPPostingSuccess)
                                    {
                                        ...
                                        {                                            
                                            ...
                                            OuterLabelDTO objOuterLabelDTO = FinalPackingBLL.PrintInnerandOuter(objFinalPackingDTO.Internallotnumber, _GCLabelPrintingRequired == Constants.ONE ? true : false, _BarcodeVerificationRequired == Constants.ONE ? true : false);
        ...
        //20221001: HSB SIT2 Issue# 36: MTS pallet not require insert record into EWN_CompletedPallet table.
        ...
        //            FinalPackingBLL.InsertEWareNaviData(_palletid, isPreship, _itemNumber, _palletcapacity, objFinalPackingDTO.Ponumber, objFinalPackingDTO.Size);
        //    }
        //    else
        //    {
        //        if (FinalPackingBLL.ValidatePalletCapacity(_palletid, _poNumber, _itemNumber, _size) == _palletcapacity)
        //            FinalPackingBLL.InsertEWareNaviData(objFinalPackingDTO.Palletid, isPreship, _itemNumber, _palletcapacity, objFinalPackingDTO.Ponumber, objFinalPackingDTO.Size);        
        //    }
        ...
        private Boolean SerilaNumberValidation(decimal serialNumber, Boolean isfromPrint = false)
        {
            ...
            //string batchOrder = string.Empty;
                            ...
                            else if (FinalPackingBLL.ValidateSerialNoByQIStatus(serialNumber) == Constants.PASS)
                            {
                                    ...
                                    && ValidateQATestResult(Convert.ToDecimal(txtSerialNumber.Text.Trim()), Constants.HOTBOX_TEST))
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        {
                                            objBatchDTO = FinalPackingBLL.ValidateSerialNumberGloveCode(Convert.ToDecimal(txtSerialNumber.Text.Trim()), _GloveCode, _size, _AlternativeGloveCode1, _AlternativeGloveCode2, _AlternativeGloveCode3, _innerBoxCapacity);
                                        ...
                                        else
                                        {
                                            objBatchDTO = FinalPackingBLL.ValidateSerialNumberGloveCode(Convert.ToDecimal(txtSerialNumber.Text.Trim()), _GloveCode, _size, _AlternativeGloveCode1, _AlternativeGloveCode2, _AlternativeGloveCode3, _innerBoxCapacity);
                                            batchNumber = objBatchDTO.BatchNumber;
                                            //batchOrder = objBatchDTO.BatchOrder;
                                            _ProductionDate = objBatchDTO.BatchCarddate;
                                            _LineId = objBatchDTO.Line;
                                            _isTempack = false;
                                        }
        ...
        private void GetActivePOList()
        {
            try
            {
                List<DropdownDTO> lstSurgicalOrders = FinalPackingBLL.GetFirstGradePOMTSList().Distinct<DropdownDTO>().ToList();
            ...
            try
            {
                if (cmbPurchaseOrder.SelectedIndex > Constants.MINUSONE)
                {
                    ...
                    if (selectDto.CustomField == "StartedUp")
                    {
                        ...
                        lstPODetails = FinalPackingBLL.GetPurchaseOrderMTSList(cmbPurchaseOrder.SelectedValue.ToString());
        ...
        private static bool PostAXData(string internallotnumber)
        {
            ...
            try
            {
                isPostingSuccess = AXPostingBLL.PostAXDataFinalPackingMTS(internallotnumber, Convert.ToString(Convert.ToInt16(Constants.SubModules.ScanBatchCardInnerOuter)));
            }
            catch (Exception ex)
            {
