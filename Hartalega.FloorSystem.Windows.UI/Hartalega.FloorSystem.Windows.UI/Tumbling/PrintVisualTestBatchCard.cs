// -----------------------------------------------------------------------
// <copyright file="PrintVisualTestBatchCard.cs" company="Avanade">
...
namespace Hartalega.FloorSystem.Windows.UI.Tumbling
{
    ...
    /// File Type: Code file
    /// </summary> 
    public partial class PrintVisualTestBatchCard : FormBase
    {
        #region Static Variables
        public static BatchDTO _resultDTO;
        public static string _previousGloveType;
        private static string _screenName = "Tumbling - PrintVisualTestBatchCard";
        private static string _className = "PrintVisualTestBatchCard";
        ...
        #region Load Page
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintVisualTestBatchCard" /> class.
        /// </summary>
        public PrintVisualTestBatchCard()
        {
            InitializeComponent();
        ...
        private void PrintVisualTestBatchCard_Load(object sender, System.EventArgs e)
        {
            try
            {
                GetType();
        ...
        private void GetSizeByGloveType()
        {
            ...
            {
                ExceptionLogging(ex, "Tumbling - PrintLostBatchCard", "PrintLostBatchCard", "getSizeByGloveType", txtGloveType.Text);
            }
        }
        ...
        private void SaveBatchCard(string authorizedBy,int authorizedFor)
        {
            ...
            try
            {
                ...
                CommonBLL.PrintDetails(batchDateTime.ToString("HH:mm:ss"), _resultDTO.SerialNumber, _resultDTO.BatchNumber, objBatchDTO.BatchWeight.ToString(), objBatchDTO.Size, objBatchDTO.TenPcsWeight.ToString(), lblTenPcsWeight.Visible, objBatchDTO.GloveTypeDescription, String.Empty, String.Empty, false, _chckBatchWeight);
            }
            catch (FloorSystemException ex)
            {
        ...
        private void ValidateTenPcsWeight()
        {
            ...
            try
            {
                if (txtGloveType.Text != string.Empty && cmbBoxSize.Text != string.Empty)
                    weight = CommonBLL.GetMinMaxTenPcsWeightTumbling(txtGloveType.Text, cmbBoxSize.Text);
            }
            catch (FloorSystemException ex)
            {
                ExceptionLogging(ex, _screenName, _className, "validateTenPcsWeight", txtGloveType.Text, cmbBoxSize.Text);
                return;
            }
