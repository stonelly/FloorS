// -----------------------------------------------------------------------
// <copyright file="PrintLostBatchCard.cs" company="Avanade">
...
namespace Hartalega.FloorSystem.Windows.UI.Tumbling
{
    ...
    /// File Type: Code file
    /// </summary> 
    public partial class PrintLostBatchCard : FormBase
    {
        #region Static Variables
        public static BatchDTO _resultDTO;
        public static string _previousGloveType;
        private static string _screenName = "Tumbling - PrintLostBatchCard";
        private static string _className = "PrintLostBatchCard";
        ...
        #region Load Page
        /// <summary>
        /// Initializes a new instance of the <see cref="PrintLostBatchCard" /> class.
        /// </summary>
        public PrintLostBatchCard()
        {
            InitializeComponent();
        ...
        private void PrintLostBatchCard_Load(object sender, System.EventArgs e)
        {
            try
            {
                GetLostArea();
            ...
            {
                ExceptionLogging(ex, _screenName, _className, "PrintLostBatchCard_Load", null);
                return;
            }
        }
        #endregion
        ...
        /// Fill Lost Area
        /// </summary>
        private void GetLostArea()
        {
            try
            {
                //Bind Lost Area 
                cmbBoxLostArea.DataSource = CommonBLL.GetEnumText(Constants.LOST_AREA);
                cmbBoxLostArea.DisplayMember = "DisplayField";
                cmbBoxLostArea.ValueMember = "IDField";
                cmbBoxLostArea.SelectedValue = WorkStationDTO.GetInstance().Area;
                //Set the focus field to OperatorID
                txtOperatorId.Focus();
            }
            catch (FloorSystemException ex)
            {
                ExceptionLogging(ex, _screenName, _className, "getSizeAndLostArea", null);
                return;
            }
        }
        #endregion
        ...
        private void GetSizeByGloveType()
        {
            ...
            {
                // Bind Size Data
                cmbBoxSize.DataSource = CommonBLL.GetSizeByGloveTypeTumbling(txtGloveDescription.Text);
        ...
        private void GetGloveDescriptionIfValid()
        {
            ...
            try
            {
                ...
                {
                    gloveDescription = Convert.ToString(TumblingBLL.GetRejectGloveCategory(txtGloveType.Text.Trim()));
                ...
                else if (!string.IsNullOrEmpty(_previousGloveType))
                {
                    ClearForm(Constants.EXCLUDE_OPERATOR);
        ...
        private void SaveBatchCard(string authorizedBy,int authorizedFor)
        {
            ...
            objBatchDTO.BatchType = Constants.LOST_BATCH_TYPE;
            ...
            objBatchDTO.BatchLostArea = cmbBoxLostArea.SelectedValue.ToString();
            ...
            try
            {
                ...
                _GloveCategory = TumblingBLL.GetRejectGloveCategory(txtGloveDescription.Text);
                objBatchDTO.GloveTypeDescription = txtGloveDescription.Text.ToString() + Environment.NewLine + Constants.TAB + _GloveCategory;

                CommonBLL.PrintDetails(batchDateTime.ToLongTimeString(), _resultDTO.SerialNumber, _resultDTO.BatchNumber, objBatchDTO.BatchWeight.ToString(), objBatchDTO.Size, objBatchDTO.TenPcsWeight.ToString(), lblPcsWeight.Visible, objBatchDTO.GloveTypeDescription, String.Empty, String.Empty, false, _chckBatchWeight);
            }
            catch (FloorSystemException ex)
            {
        ...
        private void ValidateTenPcsWeight()
        {
            ...
            try
            {
                if (txtGloveType.Text != string.Empty && cmbBoxSize.Text != string.Empty)
                    weight = CommonBLL.GetMinMaxTenPcsWeightTumbling(txtGloveDescription.Text, cmbBoxSize.Text);
            }
            catch (FloorSystemException ex)
            {
        ...
        private bool ValidateRequiredFields()
        {
            ...
            validationMesssageLst.Add(new ValidationMessage(cmbBoxLostArea, Constants.LOST_AREA, ValidationType.Required));
            return ValidateForm();
        }
