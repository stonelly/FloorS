...
namespace Hartalega.FloorSystem.Windows.UI.Tumbling
{
    ...
    public partial class PrintNormalBatchCard : FormBase
    {
        ...
        #region Load Form
        public PrintNormalBatchCard()
        {
            WorkStationDTO.GetInstance().Module = CommonBLL.GetModuleId(Constants.TUMBLING_SYSTEM);
            WorkStationDTO.GetInstance().SubModule = CommonBLL.GetSubModuleId(_screenName);
            InitializeComponent();
            LoadFormData();
            ...
            txtQty.Text = "0"; //#Azrul 20200112: Temp disabled, Follow print SRBC Qty default to 0.
        }
        ...
        private void GetLine()
        {
            ...
            cmbLine.DataSource = TumblingBLL.GetTumblingResource(locationId, null, null, null);
        ...
        private void GetResource(string lineId)
        {
            ...
            cmbResource.DataSource = TumblingBLL.GetTumblingResource(locationId, lineId, null, null);
        }
        ...
        private void GetBatchOrder(string lineId, string resource)
        {
            ...
            cmbBatchOrder.DataSource = TumblingBLL.GetTumblingResource(locationId, lineId, resource, null);
        ...
        {
            List<BatchOrderDetailsDTO> BODetailsForPrint = TumblingBLL.GetTumblingResource(locationId, lineId, resource, batchOrder);
        ...
        private void SaveBatchCard(string authorizedBy, int authorizedFor)
        {
            ...
            try
            {
                lstBatchDTO = TumblingBLL.GetPrintBatchDetails(userId, shiftId, line, batchCardDate, ModuleId, SubModuleID, sitenumber, WorkStationNumber, resource, batchOrder, gloveCode, size, batchWeight, quantity, authorizedBy, authorizedFor);
