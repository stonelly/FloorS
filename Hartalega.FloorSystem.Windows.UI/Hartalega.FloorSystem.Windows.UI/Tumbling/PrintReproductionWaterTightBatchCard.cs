...
{
    public partial class PrintReproductionWaterTightBatchCard : FormBase
    {
        #region Static Variables
        public static BatchDTO _resultDTO;
        public static string _previousGloveType;
        private static string _screenName = "Tumbling - PrintReproductionWaterTightBatchCard";
        private static string _className = "PrintReproductionWaterTightBatchCard";
        ...
        /// </summary>
        public PrintReproductionWaterTightBatchCard()
        {
            InitializeComponent();
        ...
        private void PrintReproductionWaterTightBatchCard_Load(object sender, System.EventArgs e)
        {
            try
            {
                GetProdType();
        ...
        private void GetShift()
        {
            ...
            {
                ExceptionLogging(ex, _screenName, _className, "getShift", WorkStationDTO.GetInstance().Location, Framework.Constants.ShiftGroup.PN);
                return;
            }
        }
        /// <summary>
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                ExceptionLogging(new FloorSystemException(ex.Message, Constants.AXSERVICEERROR, ex, true), _screenName, _className, "btnPrint_Click", null);
            }
        }
        ...
        private void GetLineByGloveType()
        {
            try
            {
                ...
                //cmbBoxLine.DataSource = CommonBLL.GetAllLinesByLocation(WorkStationDTO.GetInstance().Location); //24-10-2018 #AZRUL: Decoupled Production Line Table
        ...
        private void SaveBatchCard(string authorizedBy, int authorizedFor)
        {
            ...
            {
                //Azman 14022018
                //_resultDTO = TumblingBLL.SaveWaterTightBatchCard(objBatchDTO);
