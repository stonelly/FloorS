<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QCDefectAnalysisSystem.aspx.cs" Inherits="Hartalega.FloorSystem.Web.UI.TV.QCDefectAnalysisSystem" %>
...
<head runat="server">
    ...
    <script>
        function ShrinkGrid() {
            MaxMinGrid($('#QCDefectGridView'), $('#QCDefectGridView tr:not(:first)'), $('#footergrid'), screen.height, $('#mainDiv'), $('body'));
        }
    </script>
</head>
                ...
                <ContentTemplate>
                    <div id="mainDiv" style="width: 100%; margin: 0px; padding: 0px; float: left; padding-top: 0.2%; padding-bottom: 0.2%">
                        ...
                        <div id="contentDiv" style="width: 100%; float: left; margin: 0px;">
                            <asp:GridView ID="QCDefectGridView" runat="server" AutoGenerateColumns="true"
