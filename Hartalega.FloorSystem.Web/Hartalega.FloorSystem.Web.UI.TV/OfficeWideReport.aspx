<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OfficeWideReport.aspx.cs" Inherits="Hartalega.FloorSystem.Web.UI.TV.OfficeWideReport" %>
...
<body style="overflow: hidden">
    <form id="form1" runat="server">
        ...
        <div style="width: 99%; height: 100%; position: fixed">
            <iframe id="OfficeFrame" runat="server" style="width: 100%; height: 100%"></iframe>
        </div>
    </form>
</body>
