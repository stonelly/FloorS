<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CosmeticDefectAnalysisSystem.aspx.cs" Inherits="Hartalega.FloorSystem.Web.UI.TV.CosmeticDefectAnalysisSystem" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ShrinkGrid() {
            MaxMinGrid($('#CosmeticDefectGridView'), $('#CosmeticDefectGridView tr:not(:first)'), $('#footergrid'), screen.height, $('#mainDiv'), $('body'));
        }
                ...
                <ContentTemplate>
                    ...
                    <div id="mainDiv" style="width: 100%; margin: 0px; padding: 0px; float: left; padding-top: 0.2%; padding-bottom: 0.2%">
                        ...
                        <div id="contentDiv" style="width: 100%; float: left; margin: 0px;">
                            ...
                            <asp:GridView ID="CosmeticDefectGridView" runat="server" AutoGenerateColumns="true"
                                Width="100%">
